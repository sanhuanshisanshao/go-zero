...
import (
	"github.com/sanhuanshisanshao/go-zero/tools/goctl/api/apigen"
	"github.com/sanhuanshisanshao/go-zero/tools/goctl/api/dartgen"
	"github.com/sanhuanshisanshao/go-zero/tools/goctl/api/docgen"
	"github.com/sanhuanshisanshao/go-zero/tools/goctl/api/format"
	"github.com/sanhuanshisanshao/go-zero/tools/goctl/api/gogen"
	"github.com/sanhuanshisanshao/go-zero/tools/goctl/api/javagen"
	"github.com/sanhuanshisanshao/go-zero/tools/goctl/api/ktgen"
	"github.com/sanhuanshisanshao/go-zero/tools/goctl/api/new"
	"github.com/sanhuanshisanshao/go-zero/tools/goctl/api/tsgen"
	"github.com/sanhuanshisanshao/go-zero/tools/goctl/api/validate"
	"github.com/sanhuanshisanshao/go-zero/tools/goctl/plugin"
...
func init() {
	...
	Cmd.Flags().StringVar(&apigen.VarStringRemote, "remote", "", "The remote git repo of the"+
		...
		" https://github.com/sanhuanshisanshao/go-zero-template directory structure")
	...
	goCmd.Flags().StringVar(&gogen.VarStringStyle, "style", "gozero", "The file naming format,"+
		" see [https://github.com/sanhuanshisanshao/go-zero/blob/master/tools/goctl/config/readme.md]")
	...
	pluginCmd.Flags().StringVar(&plugin.VarStringStyle, "style", "",
		"The file naming format, see [https://github.com/sanhuanshisanshao/go-zero/tree/master/tools/goctl/config/readme.md]")
