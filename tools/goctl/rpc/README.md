...
Flags:
  ...
  -m, --multiple          Generated in multiple rpc service mode
      ...
      --style string      The file naming format, see [https://github.com/sanhuanshisanshao/go-zero/tree/master/tools/goctl/config/readme.md] (default "gozero")
...
## rpc 服务生成 example
详情见 [example/rpc](https://github.com/sanhuanshisanshao/go-zero/tree/master/tools/goctl/example)
