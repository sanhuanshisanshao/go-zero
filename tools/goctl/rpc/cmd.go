...
import (
	"github.com/sanhuanshisanshao/go-zero/tools/goctl/rpc/cli"
...
func init() {
	...
	newCmd.Flags().StringVar(&cli.VarStringStyle, "style", "gozero", "The file "+
		"naming format, see [https://github.com/sanhuanshisanshao/go-zero/tree/master/tools/goctl/config/readme.md]")
