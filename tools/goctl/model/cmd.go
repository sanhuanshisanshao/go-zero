...
import (
	...
	"github.com/sanhuanshisanshao/go-zero/tools/goctl/model/mongo"
	"github.com/sanhuanshisanshao/go-zero/tools/goctl/model/sql/command"
)
...
func init() {
	...
	ddlCmd.Flags().StringVar(&command.VarStringStyle, "style", "", "The file naming format, see [https://github.com/sanhuanshisanshao/go-zero/tree/master/tools/goctl/config/readme.md]")
	...
	datasourceCmd.Flags().StringVar(&command.VarStringStyle, "style", "", "The file naming format, see [https://github.com/sanhuanshisanshao/go-zero/tree/master/tools/goctl/config/readme.md]")
	...
	pgDatasourceCmd.Flags().StringVar(&command.VarStringStyle, "style", "", "The file naming format, see [https://github.com/sanhuanshisanshao/go-zero/tree/master/tools/goctl/config/readme.md]")
	...
	mongoCmd.Flags().StringVar(&mongo.VarStringStyle, "style", "", "The file naming format, see [https://github.com/sanhuanshisanshao/go-zero/tree/master/tools/goctl/config/readme.md]")
