...
> 
> `GOPROXY=https://goproxy.cn/,direct go install github.com/sanhuanshisanshao/go-zero/tools/goctl@latest`
> 
...
```shell
GO111MODULE=on GOPROXY=https://goproxy.cn/,direct go get -u github.com/sanhuanshisanshao/go-zero
```
...
1. 安装 goctl 工具
    ...
    ```shell
    # Go 1.15 及之前版本
    GO111MODULE=on GOPROXY=https://goproxy.cn/,direct go get -u github.com/sanhuanshisanshao/go-zero/tools/goctl@latest
...
如果贵公司也已使用 go-zero，欢迎在 [登记地址](https://github.com/sanhuanshisanshao/go-zero/issues/602) 登记，仅仅为了推广，不做其它用途。
